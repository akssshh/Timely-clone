        ...
        <div className="relative group">
          ...
          <div className="hidden group-hover:block absolute z-10 bg-gray-800 py-2 mt-2 rounded-md shadow-lg">
            ...
            <div className="grid grid-cols-5 gap-4 px-4">
              <a href="#" className="block text-sm text-white hover:bg-gray-700">Column 1</a>
              <a href="#" className="block text-sm text-white hover:bg-gray-700">Column 2</a>
              <a href="#" className="block text-sm text-white hover:bg-gray-700">Column 3</a>
              <a href="#" className="block text-sm text-white hover:bg-gray-700">Column 4</a>
              <a href="#" className="block text-sm text-white hover:bg-gray-700">Column 5</a>
            </div>
          </div>
        </div>
