  ...
  return (
    ...
    <nav className="bg-primary border-gray-200 h-[72px] dark:border-gray-600 dark:bg-gray-900   ">
      <div className="flex flex-wrap  justify-between items-center mx-auto max-w-screen-xl pr-0 md:pr-0 py-4 md:p-0 max-w-[1280px] h-[72px] ">
        ...
        <div id="mega-menu-full-cta" className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1  mt-[14px] md:mt-0 bg-primary mobile-nav-bg ">
          <ul className="flex items-center  flex-col mt-[0px] font-medium md:flex-row md:space-x-6 md:mt-0 min-h-screen md:min-h-0 pt-4 md:pt-0 px-9 md:px-0 gap-y-4 md:gap-y-0 ">
            ...
            <li className='md:hidden' >
              <div id="mega-menu-full-cta-dropdown" className="mt-[40px] md:mt-1  md:max-w-[1280px] mx-auto  " >
                <div className="gap-x-4 md:grid grid-cols-2  grid-template py-5 grid-auto-cols-1fr px-9 md:px-0   ">

                  <ul className="grid gap-x-8 grid-cols-auto-fit grid-cols-minmax-10 bg-white relative " aria-labelledby="mega-menu-full-cta-button">
                    <li className='' >
                      <a href="#" className="">
                  ...
                  <div className=" py-4 md:mt-0 bg-white relative  ">
      ...
      { isOpen && (<div id="mega-menu-full-cta-dropdown" className="mt-[40px] md:mt-1  md:max-w-[1280px] mx-auto hidden md:block" >
        <div className="gap-x-4 md:grid grid-cols-2  grid-template py-5 grid-auto-cols-1fr px-9 md:px-0   ">
